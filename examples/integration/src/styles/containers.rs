...
pub const HOVERED: Color =
    Color::from_rgb(129.0 / 255.0, 129.0 / 255.0, 129.0 / 255.0);
pub const ACCENT: Color =
    Color::from_rgb(15.0 / 255.0, 85.0 / 255.0, 179.0 / 255.0);
pub const SUCCESS: Color =
    Color::from_rgb(31.0 / 255.0, 139.0 / 255.0, 36.0 / 255.0);
pub const WARNING: Color =
    Color::from_rgb(212.0 / 255.0, 176.0 / 255.0, 17.0 / 255.0);
pub const ERROR: Color =
    Color::from_rgb(218.0 / 255.0, 16.0 / 255.0, 11.0 / 255.0);
